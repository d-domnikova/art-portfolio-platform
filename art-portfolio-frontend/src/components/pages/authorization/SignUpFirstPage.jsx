...
export default function SignUpFirstPage(){
    ...
    <div className="md:grid md:grid-cols-7 h-full gap-3 w-full h-full">
        ...
        <div className="col-span-4 h-full flex flex-col items-start pt-12 md:pt-0">
            <div className="m-auto w-[80%] lg:w-[50%] flex flex-col justify-start space-y-5 pt-8 pb-6"> 
